...
import AvatarStack from "../../examples/vite-react-avatar-stack-2/src/App";
...
const Project = ({ spaces }: { spaces: Spaces }) => {
  ...
  useEffect(() => {
    setProjectInfo({
      name: "React Avatar stack Version 2",
      docsLink: "https://ably.com/docs/spaces/avatar",
      repoNameAndPath: "realtime-examples/tree/main/examples/vite-react-avatar-stack-2",
      topic: "avatar-stack",
      learnMore: true,
      description:
